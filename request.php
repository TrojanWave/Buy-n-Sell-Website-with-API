...
<div class="super_container">
	...
	<div class="single_product">
		<div class="container">
			...
			<?php
				$request_result = getRequest($ad_id);
			...
			?>
				...
				<div class="col-lg-5 order-3" style="border: 2px solid #A19189; padding: 15px; border-radius: 10px;">
					<div class="product_description">
						...
						<div class="product_text"><p><?php echo $row_request["description"]; ?></p></div>
						<div class="order_info d-flex flex-row">
							<form>
								<div class="product_price">Rs: <?php echo $row_request["price_min"]; ?>/- to <?php echo $row_request["price_max"]; ?>/-</div><br>
								<div class="product_price">Contact: 0<?php echo $row_request["contact"]; ?></div>
							</form>
						</div>
					</div>
				</div>
